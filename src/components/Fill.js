...
function Fill (props) {
  ...
  const handleInputFil = (ev) => {
    ...
    <div className="fill-inputs-section section-to-hide">
      ...
      <GetImage avatar={props.dataCard.photo} updateAvatar={props.handleInput} />
      
     
      <label htmlFor="email" className="text-fill">email</label>
      <input type="text" name="email"
        value={props.dataCard.email}
        onChange={handleInputFil} placeholder="Ej: adalab@adalab" required="" className="js-email-input" />
      ...
      <input type="text" name="linkedin"
        ...
        onChange={handleInputFil} placeholder="Ej: https://www.linkedin.com/school/adalab/" className="js-link-input" required="" />
      <label htmlFor="github" className="text-fill">github</label>
      <input type="text" name="github"
        value={props.dataCard.github}
        onChange={handleInputFil} className="js-git-input" placeholder="Ej: @Adalab"
        required="" />
    </div>
  </fieldset>)
}
